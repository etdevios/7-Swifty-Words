...
//  Project 8
//
//  Created by Eduard Tokarev on 04.01.2022.
//
...
class ViewController: UIViewController {
    ...
    @objc func letterTapped(_ sender: UIButton) {
        ...
        activatedButtoms.append(sender)
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "You are Wrong!", message: "You enters an incorrect guess.", preferredStyle: .alert)
